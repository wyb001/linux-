...
type:"GET",
success:function(i){
if(console.info("[沉浸式播放器数据响应请求]: ",i),t.info("[Player] success get immersive data"),
...
var n=e("biz_wap/jsapi/log.js"),a=e("pages_new/common_share/video/player/player.html.js"),r=e("biz_wap/utils/device.js"),h=e("biz_wap/utils/mmversion.js"),u=e("new_video/ctl.js"),l=e("pages/version4video.js"),d=e("biz_wap/jsapi/core.js"),c=e("new_video/plugin/util.js"),p=e("biz_wap/utils/jsmonitor_report.js"),g=e("common/utils.js"),_=e("biz_wap/utils/ajax.js"),m=e("appmsg/set_font_size.js"),f=m.fontSizePlugin,v=e("pages_new/modules/utils/vue_plugin.js"),y=v.VueExposePlugin;
t.use(f),t.use(y);
var S=e("pages_new/modules/toast/toast.js"),T=e("biz_wap/utils/openUrl.js"),w=e("biz_common/utils/url/parse.js"),b=e("pages/utils.js"),P=b.formatReadNum,A={
...
try{
A._debug=window.location.href.indexOf("&_debug=1")>0;
}catch(k){
A._debug=!1;
}
var I=h.getInner();
window.parent===window&&h.isWechat&&!h.isInMiniProgram&&(r.os.iphone&&h.gtVersion("7.0.15",1)&&r.os.getNumVersion()>=10.3||r.os.android&&(I>"27001037"&&"27001060">I||I>="27001100")&&r.os.getNumVersion()>=5)&&(A.wcSlPlayerSupport=!0),
console.log("support wcslplayer",A.wcSlPlayerSupport);
var B=function(e){
return A._debug&&console.log(e);
},C=function(e,t){
...
return _extends({},A.allPlayersOfPage);
},R=function(){
...
width:function(){
return Math.min(this.opt.width||300,A.screenWidth);
},
height:function(){
return Math.min(this.opt.height||300,A.screenLength);
},
ratio:function(){
...
return A.showFullscreenMenu&&!!this.opt.showFullscreenMenu;
},
...
var e={
width:(this.isLandscape?A.screenLength:A.screenWidth)+2+"px",
height:"100%",
position:"absolute",
padding:"0 1px",
left:"-1px",
...
width:A.screenLength+"px",
height:A.screenWidth+"px"
}:_extends({
display:"block",
width:this.width+"px",
height:this.height+"px"
...
return{
bottom:(A.screenLength-Math.min(A.screenLength,A.screenWidth/this.videoRatio))/2+16+"px"
};
},
...
A.allPlayersOfPage[this.id]=this,d.on("onNetWorkChange",this.onNetworkChange),d.on("menu:haokan",this.onLikedCommentWrite),
...
this.isImmersiveMode&&(this.handleFullscreenChange({
state:!0,
type:"immersive"
...
}),this.opt.preCreate||d.on("onNavigationBarRightButtonClick",this.onShowFullscreenMenu)),
this.opt.initFullscreenStatus&&this.enterFullscreen(),this.needFeFullscreen&&(window.addEventListener("unload",this.exitFullscreen),
d.on("onMPCustomMenuItemClick",this.onFullscreenMenuClick),r.os.android&&!this.isImmersiveMode&&d.on("onExitFullscreen",this.__onAndroidExitFullscreen=function(){
...
delete A.allPlayersOfPage[this.id],d.remove("onNetWorkChange",this.onNetworkChange),
...
var i=A.nettypeMap[t.err_msg]||"fail";
("network_type:edge"==t.err_msg||"network_type:wwan"==t.err_msg)&&(t.detailtype&&A.cellType.indexOf(t.detailtype)>-1||t.subtype&&A.cellType.indexOf(t.subtype)>-1)&&(i=t.detailtype||t.subtype),
e.__lastNetworkType={
networkType:i,
simType:t.simtype
};
...
.1>=i&&(t.needToFit=!0,C("objectFit","fill")&&(t.supportObjectFit=!0,this.fitVideo=!0));
}
...
e>0&&(0===t||this.__serialTimeupdateCache[t-1].currentTime!=e)&&(this.__serialTimeupdateCache.length>=A.timeupdateCacheCount&&this.__serialTimeupdateCache.shift(),
...
if(this.__serialTimeupdateCache.length<A.timeupdateCacheCount)return!1;
var e=this.__serialTimeupdateCache.length,t=this.__serialTimeupdateCache[e-1],i=this.__serialTimeupdateCache[e-A.timeupdateCacheCount];
...
var e=this;
Object.keys(A.allPlayersOfPage).forEach(function(t){
e.id!==t&&(A.allPlayersOfPage[t].pause(),A.allPlayersOfPage[t].opt.inFeed||(A.allPlayersOfPage[t].showMidPlayBtn(),
A.allPlayersOfPage[t].hideControlBar()));
});
},
...
},A.loadingTimeout),this.__waitingTimeoutId&&(clearTimeout(this.__waitingTimeoutId),
this.__waitingTimeoutId=null);
var s=0;
try{
for(var o in A.allPlayersOfPage)if(A.allPlayersOfPage.hasOwnProperty(o)&&s++,s>1)break;
}catch(n){}
...
for(var t=e.$refs.video,i=e.$refs.poster,s=h.isIOS&&A.screenLength>=812?34:0,o=Math.min(A.screenLength,A.screenWidth/e.videoRatio),n=[0,56+s,84+s,150+s,190+s],a=1;a<n.length;a++)if(.55*A.screenLength-o/2<n[a]){
var u=function(){
for(var s=0,h=a-1;h>=0&&(s=(A.screenLength-o)/2-n[h],!(o/2-s<A.screenLength/2));h--);
...
r.os.android&&t&&!t.style.marginTop&&(t.style.marginTop=-.05*A.screenLength+"px",
t.style.marginBottom=.05*A.screenLength+"px");
}();
},
...
B("onPointerUpHandler dragTime:"+o+" currentTime:"+this.$refs.video.currentTime),
...
this.videoRatio<=1||this.fullscreenStatus&&(this.isLandscape||A.outerWidth===window.outerWidth?this.isLandscape&&A.outerWidth===window.outerWidth&&(this.setOrientationStatus({
status:0
...
status:1
}),this.resetVideoFullPortraitAlign(),this.isWcSlPlayer&&this.enableWcSlPlayerFullscreenAfterOrientationChange&&this.$refs.video.requestFullscreen(window.orientation,{
updateStyleOnly:this.updateStyleOnly
})));
},
...
"number"!=typeof e&&(e=1),(t||0===window.isFans&&A.supportSubscribe&&(0===this.subscribeStatus&&1===e||1===this.subscribeStatus&&2===e))&&(this.subscribeStatus=e,
...
click:!0
}),this.isWcSlPlayer||this.isFeFullscreen?(this.__originFullscreenStatus=!0,this.enableWcSlPlayerFullscreenAfterOrientationChange="update-style-only",
this.handleFullscreenChange({
state:!0,
type:"frontend"
}),void(this.opt.preCreate||(h.isIOS?(setTimeout(function(){
d.invoke("setNavigationBarColor",{
color:"#000000",
alpha:0
});
...
this.__originFullscreenStatus=!1,this.enableWcSlPlayerFullscreenAfterOrientationChange=!this.opt.preCreate,
...
},g=this.opt.extinfo,_=g&&g.vid||"",m={
...
},2e3)),d.invoke("handleMPPageAction",m,function(t){
...
i.play()),s();else{
var o=i.play();
"object"===("undefined"==typeof o?"undefined":_typeof(o))?o.then(s).catch(function(e){
...
return window.__failConfigWxOpen?!1:this.__fallbackFromWcSlVideoToH5Player?!1:A.wcSlPlayerSupport;
},
...
var t=this;
if(A.statusDefine[e.status]&&(!e.subStatus||A.subStatusDefine[e.subStatus]||"error"===e.status)&&(this.status!==e.status||this.subStatus!==e.subStatus)){
var i=0;
...
var s=/^https?:\/\/\[/.test(t.src)?"Player:IPv6Error":"Player:IPv4Error",o="errorCode: "+e.subStatus+"; errorMsg: "+e.errorMsg+"; src: "+t.src+"; "+(window.__second_open__?"secopen":"h5")+"; res: "+JSON.stringify(i);
...
B(n),this.triggerEvent("statusChange",{
...
shareVideo:function(){
return console.log("?????share",this.opt.extinfo,this.canShareVideo,this.needFeFullscreen,r.os.ipad,this.supportImmersiveMode),
this.opt.extinfo&&this.opt.extinfo.preview?void window.weui.alert("预览状态下无法分享视频"):void(this.canShareVideo&&((this.needFeFullscreen||r.os.ipad)&&this.supportImmersiveMode?(d.invoke("handleMPPageAction",{
action:"share"
}),console.log("????????api1"),this.triggerEvent("shareVideo"),this.showSubscribeBtn()):this.supportNativeFullPlayer&&(console.log("????????api2"),
...
var e=this;
return A.supportZaikanAutho&&!e.isLiked?void setTimeout(function(){
...
var i=t,s=e;
A.supportZaikanAutho?setTimeout(function(){
WeixinJSBridge.invoke("handleHaokanAction",{
action:"checkSyncHaoKanPermission"
},function(e){
var t=e.result;
...
var e=this;
0===window.isFans&&A.supportSubscribe&&1===this.subscribeStatus&&(d.invoke("quicklyAddBrandContact",{
