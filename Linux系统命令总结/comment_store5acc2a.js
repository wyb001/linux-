...
var e=t("biz_wap/utils/ajax.js"),n=t("pages_new/common_share/video/player/plugins/base.js"),i=t("pages_new/common_share/video/player/plugins/danmu/input.html.js"),s=t("pages_new/common_share/video/player/plugins/danmu/danmu_util.js"),r=t("common/keyboard.js"),o=t("biz_common/utils/url/parse.js"),a=t("appmsg/emotion/weemoji.js"),u=a.EmojiData||[],l=t("biz_wap/utils/mmversion.js"),m=t("biz_wap/jsapi/core.js"),d=t("biz_wap/utils/storage.js"),c=t("biz_wap/utils/jsmonitor_report.js"),p=t("pages_new/3rd/vuex.js"),h=p.mapState,_=p.mapMutations,f="xs",g="s",w=3,v=6,y=.6,P=.6,S=31536e7,T=2,b='<img src="https://res.wx.qq.com/mpres/zh_CN/htmledition/comm_htmledition/images/pic/common/pic_blank.gif" class="icon_emotion_single we-emoji #name#" alt="" />',j={
"default":"无法发弹幕",
1:"关注可发",
2:"关注7天可发"
},O={
...
}),h("mp-video-player",["fullscreenStatus","seekingStatus","orientationStatus"]),h("mp-video-player/danmu-plugin",["inputStatus","danmuInfo"]),{
vid:function(){
...
var n=-1!==[9,70,10002].indexOf(1*window.appmsg_type)&&!!e.is_allow_danmu;
if(t.setDanmuInfo({
isAllow:n,
...
complete:function(){
clearTimeout(n),t.controller.triggerEvent("danmuPluginInited");
}
});
},
init:function(){
...
rate:this.fullscreenStatus?P:y
...
t||(this.switchOn=!this.switchOn,this.LS.set("switch",this.switchOn?1:2,Date.now()+S),
...
var n=parseInt(e.currentTime,10);
this.controller.__danmuUtil.updateTime(n),n>this.step-T&&(this.requestDanmu(),this.step=this.getCurTime(5));
}
},
...
this.controller.__danmuUtil.setLine(e.state?v:w),this.controller.__danmuUtil.setRate(e.state?P:y)),
...
switch(e){
case 0:
return n.controller.getPlayer().showSubscribeBtn(),void c.setSum(221764,9,1);
...
buffer:t.buffer,
step:t.step
},n="req:"+JSON.stringify(e)+" || netType:"+o.getQuery("nettype")+" || version:"+l.getInner()+" || platform:"+l.getPlatform();
window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&window.WX_BJ_REPORT.BadJs.report("Danmu:PullTimeout",n);
},3e3),i=++this.requestCnt,s=[];
e({
type:"GET",
dataType:"json",
...
success:function(e){
if(i!==t.requestCnt)return console.warn("[Danmu Plugin Abort Pull Resp]",i,t.requestCnt,e),
...
t.step=n.next_step||t.step,t.buffer=n.buffer||t.buffer;
var o=n.list||[];
if(o.length){
...
error:function(t,e){
console.error("[Danmu Plugin Pull Error]",e),c.setSum(221764,7,1),window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&window.WX_BJ_REPORT.BadJs.report("Danmu:PullError",JSON.stringify(e));
},
complete:function(){
...
var i=u[e],s=b.replace("#name#",i.style);
if(i.cn){
var r=new RegExp("\\["+i.cn.replace(/\[|\]/g,"")+"\\]","g");
t=t.replace(r,s);
}
if(i.hk){
var o=new RegExp("\\["+i.hk.replace(/\[|\]/g,"")+"\\]","g");
t=t.replace(o,s);
}
if(i.us){
var a=new RegExp("\\["+i.us.replace(/\[|\]/g,"")+"\\]","g");
t=t.replace(a,s);
}
}
return t;
...
return I.type=n.TYPE_CONTROL,I;
