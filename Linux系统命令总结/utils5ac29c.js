...
function i(o){
var i={
bottomOpr:d("js_bottom_opr_right"),
container:d("js_like_profile_container")
};
s({
url:"/mp/getbizbanner?__biz="+window.biz+"&is_from_recommand="+(z?1:0),
type:"GET",
dataType:"json",
success:function(s){
if(!s.base_resp||0===s.base_resp.ret){
var c=s.friend_subscribe_count,b=s.is_subscribed,k=s.orignal_num,x=s.is_ban;
if(!(b||x||d("js_focus"))){
z&&p.report(23219,_extends({},g,{
Actiontype:5,
type:7
...
}),d("js_like_profile_bar").classList.remove("wx_follow_hide");
var B=m("js_function_mod_inner")[0].offsetHeight;
m("js_function_mod")[0].style.height=B+"px",i.focusBottom=d("js_focus"),i.alreadyFocusBottom=d("js_already_focus"),
...
}),r.on(d("js_like_profile_bar"),"click",function(){
o.forEach(function(o){
p.report(23219,_extends({},g,{
Actiontype:3,
type:j[o]
...
},h="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz="+b+"&scene=112#wechat_redirect",z=function(o){
