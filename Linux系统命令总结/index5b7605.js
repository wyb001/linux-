...
var m=d.os.ipad&&d.os.getNumVersion()>=13&&d.os.getNumVersion()<14,S=s.isIOS?[0,.94,1,1.06,1.15,1.24,1.29,1.4]:[0,.8,1,1.1,1.12,1.125,1.4,1.55,1.65];
...
for(var l=""+p,g=1,f=p+1;f<X.length&&p+ot>f;f++)l=l+"%2c"+f,g++;
...
var p=X[e.product_list[t].index],w=e.product_list[t].template_id;
...
M(),b.on(window,"scroll",M),K(),b.on(window,"scroll",F),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
},j=2,I=!1,x=0,k=0,T=null,z=null,R=null,S=null,W=null,M=null,K=null,H=null,V=function(){
...
console.log(t),t&&t.err_msg&&(t.err_msg.indexOf("ok")>-1?h.isIOS&&h.ltVersion("8.0.17")||h.isAndroid&&h.ltVersion("8.0.17")?window.payEduTips.firstWecoinRecharge?F.show():(C.show(),
...
var e=function(e){
C.hide(),e&&e.err_msg&&e.err_msg.indexOf("ok")>-1&&(T.innerText=e.balance,k=e.balance,
k<window.wecoin_amount?(R.innerText=window.wecoin_amount-k,S.innerText="售价 "+(window.wecoin_amount-k)/10+"元"):(z.innerText="购买全文",
R.innerText=window.wecoin_amount,S.style.display="none",K.style.display="none",M.innerText="支付"),
J.show());
};
setTimeout(function(){
...
}),T=document.getElementById("js_wecoin_remain"),z=document.getElementById("js_wecoin_title"),
R=document.getElementById("js_wecoin_price"),S=document.getElementById("js_wecoin_tips"),
...
var o=function(){
F.hide(),C.show(),v.invoke("getWCCoinBalance",{},function(e){
C.hide(),e&&e.err_msg&&e.err_msg.indexOf("ok")>-1?(T.innerText=e.balance,k=e.balance,
J.show()):I=!1;
}),window.payEduTips.firstWecoinRecharge=0;
};
b.on(t,"tap",o),F=new q(e,{
hasHeader:!1,
...
k=e.balance,z.innerText="购买全文",R.innerText=window.wecoin_amount,S.style.display="none",
...
}),T.innerText=e.balance,k=e.balance,z.innerText="微信豆不足，购买全文还需支付",R.innerText=window.wecoin_amount-e.balance,
...
b.tap(i,U),b.tap(n.getElementsByClassName("js_pay_btn")[0],U);
}();
}();
}();
...
var wt="",mt=new Image;
mt.src=("http://mp.weixin.qq.com/mp/jsreport?key=4&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key4]"+wt+"&r="+Math.random()).substr(0,1024);
}
if(window.isInWeixinApp()&&/#rd$/.test(location.href)&&!window.isWeixinCached&&!window.__second_open__&&!h.is_wxwork){
var lt=-1!=location.href.indexOf("?")?"&":"?";
location.replace(location.href.replace(/#rd$/,lt+"rd2werd=1#wechat_redirect"));
}
...
e("appmsg/qqmusic.js");
var Bt=e("appmsg/voice.js"),Ct=[];
if(voiceList&&voiceList.voice_in_appmsg&&voiceList.voice_in_appmsg.length>0&&(Ct=voiceList.voice_in_appmsg),
Bt.init(Ct),e("redpackage/redpacketcover.js"),e("appmsg/search/search.js"),e("appmsg/poi/poi.js"),
...
var Pt=e("question_answer/appmsg.js");
Pt.renderQaCard&&Pt.renderQaCard({
mid:window.mid,
idx:window.idx,
...
var Rt=e("appmsg/minishop/minishop.js"),St=window.__appmsgCgiData.minishopCardData?JSON.parse(decodeURIComponent(window.__appmsgCgiData.minishopCardData)):"";
Rt.init({
biz:window.biz,
mid:window.mid,
idx:window.idx,
...
if(-1!=z){
if(console.log("[横屏滚动检测]",n-z),500>n-z)return void(z=-1);
}else z=-1;
e[t].ori==i()&&(e[t].scroll=o,e[t].istouchmove=!0);
});
}
}(),l("[Appmsg] href:"+location.href+"^^^ ua:"+window.navigator.userAgent),window.addEventListener?window.addEventListener("load",G,!1):window.attachEvent&&window.attachEvent("onload",G),
...
e("appmsg/popup_report.js")),B=e("appmsg/pay_report_utils.js"),C=e("appmsg/loading.js"),P=e("appmsg/like_profile.js"),z=-1,R=e("appmsg/finance_communicate.js"),S=e("appmsg/topbar.js"),O=e("biz_wap/utils/jsmonitor_report.js"),q=e("pages/mod/bottom_modal.js"),N=e("appmsg/pay_read/pay_confirm_tpl.html.js"),D=e("appmsg/pay_read/buy_wecoin_btn_tpl.html.js"),W=e("pages_new/appmsg/page_bottom.js");
e("common/a11y/modal.js");
var L=e("appmsg/related_article.js"),M=e("appmsg/getForbidConfig.js"),K=e("appmsg/set_article_read.js"),H=K.setArticleRead,V="isMpUserAccessibility",J=!1;
e("appmsg/wxwork_hidden.js");
var F=e("common/color/background_color.js"),U=e("common/color/light.js"),G=e("common/color/dark.js"),Q=e("appmsg/tags_utils.js");
F.set({
bottom:[U["BG-0"],G["BG-0"]]
});
