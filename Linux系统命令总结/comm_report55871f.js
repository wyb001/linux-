...
this.evictionPolicy="noeviction",this.key=t,-1!==Object.keys(r).indexOf(e)&&(this.evictionPolicy=e),
this.init();
}
var n="__WXLS__",i=window.localStorage||{
getItem:function(){},
setItem:function(){},
removeItem:function(){},
key:function(){},
...
var t,e;
for(t=i.length-1;t>=0;t--)e=i.key(t),0==e.indexOf(n)&&i.removeItem(e);
...
check:function(t){
var n,i,r=this.getData(),c={},o=+new Date;
for(n in r)i=r[n],+i.exp>o&&(c[n]=i);
return t?c:void e.setItem(this.key,JSON.stringify(c));
},
set:function(c,o,a){
var s=this.check(!0),f=JSON.parse(JSON.stringify(s)),u=JSON.stringify(f).length;
s[c]={
val:o,
exp:a||+new Date
};
var l=JSON.stringify(s).length,h=Math.max(l-u,0);
try{
i.setItem(n+this.key,JSON.stringify(s));
}catch(v){
if(t(v)&&h>0){
var y=r[this.evictionPolicy];
s=y(f,h),s[c]={
val:o,
exp:a||+new Date
};
}
e.setItem(this.key,JSON.stringify(s));
}
},
get:function(t){
var e=this.getData();
